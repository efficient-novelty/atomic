...
DCT synthesizes spatial logic (cohesion), temporal logic (LTL), and infinitesimal structure into a single type theory, achieving an efficiency of $\rho = 12.875$, well above the current selection bar of $7.40$.
...
\begin{equation}
    \mathrm{Bar}_{15} = \Phi_{15} \cdot \Omega_{14} = \frac{610}{377} \times \frac{32}{7} = \frac{19520}{2639} \approx 7.40
\end{equation}

DCT exceeds the bar by a factor of approximately $1.74$.
