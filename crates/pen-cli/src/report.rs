...
pub fn render_debug_report(run_id: &str, steps: &[StepReport]) -> String {
    ...
    for step in steps {
        ...
        lines.push(format!(
            "  search stats: evaluated={} dedupe_prunes={} minimality_prunes={} heuristic_drops={} retained_valid={} frontier_hot={} frontier_cold={} frontier_resident={} frontier_spill={} frontier_drops={}",
