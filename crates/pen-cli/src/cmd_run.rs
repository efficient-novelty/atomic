    ...
    fn claim_run_persists_live_step_memory_checkpoints_before_acceptance() {
        ...
        writer.on_step_live_checkpoint(&StepLiveCheckpoint {
            ...
            remaining_one_telemetry: Some(pen_search::engine::RemainingOneTelemetry {
                ...
                local_exact_two_step_incumbent_priority_promotions: 1,
                local_exact_two_step_improving_prefixes_surfaced: 2,
                local_exact_two_step_first_activation_prefix_state: 5,
