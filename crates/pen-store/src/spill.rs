...
pub struct FrontierRuntimeInput<const N: usize> {
    ...
    pub incremental_terminal_clause_filter_hits: u64,
    pub incremental_terminal_clause_filter_prunes: u64,
    ...
    pub incremental_terminal_prefix_rank_hits: u64,
...
pub fn persist_frontier_runtime<const N: usize>(
    ...
    Ok(FrontierRuntimeArtifacts {
        counts: FrontierCounts {
            ...
            incremental_terminal_clause_filter_hits: input.incremental_terminal_clause_filter_hits,
            incremental_terminal_clause_filter_prunes: input
            ...
            incremental_terminal_prefix_rank_hits: input.incremental_terminal_prefix_rank_hits,
...
mod tests {
    ...
    fn spill_runtime_writes_shards_cache_blob_and_dedupe_segments() {
        ...
        let input = FrontierRuntimeInput {
            ...
            incremental_terminal_clause_filter_hits: 3,
            incremental_terminal_clause_filter_prunes: 2,
            ...
            incremental_terminal_prefix_rank_hits: 4,
        ...
        assert_eq!(artifacts.counts.incremental_terminal_prefix_rank_hits, 4);
